...
application/     # CalculatorService — delegates to domain, no business logic
...
1. `domain/arithmetic/<Name>.java` — `@Component` domain service
2. `application/CalculatorService.java` — delegate method
3. `resources/graphql/schema.graphqls` — new query
4. `infrastructure/web/graphql/CalculatorController.java` — `@QueryMapping`
